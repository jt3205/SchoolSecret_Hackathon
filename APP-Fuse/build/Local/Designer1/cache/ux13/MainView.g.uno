...
public partial class MainView: Fuse.App
{
    ...
    public partial class Template1: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template1(MainView parent, MainView parentInstance): base("Main", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        public override object New()
        {
            var __self = new global::Main(__parent.router);
            __self.Name = __selector0;
            return __self;
        }
    ...
    public partial class Template2: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template2(MainView parent, MainView parentInstance): base("Login", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
    ...
    public partial class Template3: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template3(MainView parent, MainView parentInstance): base("Sign", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        public override object New()
        {
            var __self = new global::Sign(__parent.router);
            __self.Name = __selector0;
            return __self;
        }
        static global::Uno.UX.Selector __selector0 = "Sign";
    }
    [Uno.Compiler.UxGenerated]
    public partial class Template4: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template4(MainView parent, MainView parentInstance): base("Option", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        public override object New()
        {
            var __self = new global::Option(__parent.router);
            __self.Name = __selector0;
            return __self;
        }
        static global::Uno.UX.Selector __selector0 = "Option";
    }
    [Uno.Compiler.UxGenerated]
    public partial class Template5: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template5(MainView parent, MainView parentInstance): base("Add", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        public override object New()
        {
            var __self = new global::Add(__parent.router);
            __self.Name = __selector0;
            return __self;
        }
    ...
    public partial class Template6: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template6(MainView parent, MainView parentInstance): base("SelectPeople", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        public override object New()
        {
            var __self = new global::SelectPeople(__parent.router);
        ...
        static global::Uno.UX.Selector __selector0 = "SelectPeople";
    }
    [Uno.Compiler.UxGenerated]
    public partial class Template7: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template7(MainView parent, MainView parentInstance): base("MainScreen", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        public override object New()
        {
            var __self = new global::MainScreen(__parent.router);
            __self.Name = __selector0;
            return __self;
        }
        static global::Uno.UX.Selector __selector0 = "MainScreen";
    }
    ...
    void InitializeUX()
    {
        ...
        var Main = new Template1(this, this);
        var Login = new Template2(this, this);
        var Sign = new Template3(this, this);
        var Option = new Template4(this, this);
        var Add = new Template5(this, this);
        var SelectPeople = new Template6(this, this);
        var MainScreen = new Template7(this, this);
        router.Name = __selector0;
        temp17.Children.Add(temp18);
        temp18.DefaultPath = "Splash";
        temp18.Templates.Add(Splash);
        temp18.Templates.Add(Main);
        temp18.Templates.Add(Login);
        temp18.Templates.Add(Sign);
        temp18.Templates.Add(Option);
        temp18.Templates.Add(Add);
        temp18.Templates.Add(SelectPeople);
        temp18.Templates.Add(MainScreen);
